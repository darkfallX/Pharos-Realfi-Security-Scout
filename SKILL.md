...
entrypoint:
  ...
  authentication:
    ...
    alternateHeaders:
      ...
      - x-payment-proof
env:
  SERVER_URL: https://pharos-realfi-security-scout-production.up.railway.app/health
---
...
Set `SERVER_URL` to your deployed API base (e.g. `https://pharos-realfi-security-scout-production.up.railway.app/health`).
